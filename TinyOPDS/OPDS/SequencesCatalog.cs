                        ...
                        doc.Root.Add(
                            new XElement("entry",
                                ...
                                new XElement("content",
                                    ...
                                    string.Format(Localizer.Text("Total series on {0}: {1}"), group.Key, group.Value)),
                    ...
                    foreach (var sequence in sequencesWithCount)
                    {
                        doc.Root.Add(
                            new XElement("entry",
                                ...
                                new XElement("content",
                                    StringUtils.ApplyPluralForm(sequence.BookCount, Localizer.Language,
                                        string.Format(Localizer.Text("{0} books in {1}"), sequence.BookCount, sequence.Name)),
                                    new XAttribute("type", "text")),
                                new XElement("link",
