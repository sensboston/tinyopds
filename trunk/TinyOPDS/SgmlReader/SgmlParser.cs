...
namespace TinyOPDS.Sgml
{
    ...
    internal class ElementDecl
    {
        ...
        private readonly HashSet<string> inclusions;
        private readonly HashSet<string> exclusions;

        public AttList AttList;

        public ElementDecl(string name, bool sto, bool eto, ContentModel cm, IEnumerable<string> inclusions, IEnumerable<string> exclusions)
        {
            Name = name;
            ...
            if(inclusions != null)
            {
                this.inclusions = new HashSet<string>(inclusions);
            }
