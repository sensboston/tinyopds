...
namespace TinyOPDS
{
    ...
    {
        private bool cyrillcFirst;

        public OPDSComparer(bool cyrillicFirst = true)
        {
            cyrillcFirst = cyrillicFirst;
        }
        ...
        public int Compare(object x, object y)
        {
            ...
            {
                x1 = cyrillcFirst ? (x as Genre).Translation : (x as Genre).Name;
                y1 = cyrillcFirst ? (y as Genre).Translation : (y as Genre).Name;
            }
            ...
            if (cyrillcFirst && x1.Length > 0 && y1.Length > 0)
            {
